...
def train(model, train_loader, val_loader, optimizer, criterion, max_epochs, device, model_save_path):
    ...
    for epoch in range(max_epochs):
        ...
        print(f"Val Loss: {val_loss:.4f}  Train Loss: {train_loss}  Val Acc: {val_acc:.2f}%   Train Accuracy: {train_acc}%")
    ...
    # Plotting (Requirement: Accuracy AND Loss curves)
...
def main():
    ...
    # Dataloaders (Inside main to respect Windows multiprocessing)
